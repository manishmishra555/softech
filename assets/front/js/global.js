...
$(function() {
    ...
    //quantity selector
    $(document).on('click', '.quantity-select .cartminus', function(){
    	var newValue = parseInt($(this).parent().find('.number').text(), 10);
    	var newqty = newValue>1?(newValue-1):newValue;
    	$(this).parent().find('.number').text(newqty);
    	var total_cart = $('.hiddncart').val();
    	if(total_cart > 0){
    ...
    $(document).on('click', '.quantity-select .cartplus', function(){
    	var newValue = parseInt($(this).parent().find('.number').text(), 10);
    	var newqty = newValue+1;
    	$(this).parent().find('.number').text(newqty);
    	var total_cart = $('.hiddncart').val();
    	if(total_cart > 0){
