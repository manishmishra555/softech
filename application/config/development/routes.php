...
$route['recover-password/(:any)'] = 'login/recoverPassword/$1'; 
...
$route['validateforgotPwd'] = 'login/validateforgotPwd';
$route['validateforgotupdatePwd'] = 'login/validateforgotupdatePwd';
