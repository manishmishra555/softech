            ...
            <div class="row">
                ...
                <div class="col-md-3 col-md-pull-9"> 
                    ...
                    <?php if (count($brands) > 0) {
                        ...
                        ?>
                        <label class="checkbox-entry">
                            <input type="checkbox" class="filter_var category" value="<?= $b->id; ?>"><span><?= $b->brand_name; ?></span>
                        </label>  
                    <div class="empty-space col-xs-b10"></div>
                    <?php } } ?>
                </div>
                ...
                <?php } } ?>
                    ...
                    <label class="checkbox-entry">
                        <input type="checkbox" value="male" name="male"><span>Male</span>
                    </label>
                    <div class="empty-space col-xs-b10"></div>
                    <label class="checkbox-entry">
                        <input type="checkbox" value="female" name="female"><span>Female</span>
                    </label>
                    <div class="empty-space col-xs-b10"></div>
                    <label class="checkbox-entry">
                        <input type="checkbox" value="Unisex" name="unisex"><span>Unisex</span>
                    </label>
