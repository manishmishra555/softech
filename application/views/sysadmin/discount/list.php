    ...
    <section class="content">
      ...
      <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item">Last Modified</a> <a href="#" class="dropdown-item">Name</a> <a href="#" class="dropdown-item">Size</a> </div>
          ...
          <div class="toolbar__search" style="display: none;">
            <input placeholder="Search..." type="text" name="list_searchkey" id="list_searchkey" data-control="discount" data-forms_id="add_new_discount">
            ...
            <div class="table-responsive">
              <table class="table mb-0">
                ...
                <tbody id="list_search_result">
                  ...
                  $j = 1;
                  if (!empty($discount)) {
                    foreach ($discount as $pc) {
 
                      ?>
                      <tr>
                        <th scope="row"><?php echo $j; ?></th>
                        <td><?php echo $pc->discount_name; ?></td>
                        <td>
                          <?php if (checkPermission('edit')) { ?>
                            <div class="form-group">
                              <div class="toggle-switch">
                                ...
                                <input class="toggle-switch__checkbox" type="checkbox" <?php echo $status; ?> value="<?php echo $pc->status; ?>" data-id="<?php echo $pc->did; ?>" data-control="discount" id="status<?php echo $pc->did; ?>" title="<?php echo $title; ?>">
                        ...
                        <td>
                          <div class="btn-groups">
                            <?php if (checkPermission('edit')) { ?>
                              <?php echo anchor('sysadmin/discount/edit/' . $pc->did, 'Edit', 'class="btn btn-primary waves-effect"'); ?>
                            <?php }
                                if (checkPermission('delete')) { ?>
                              <a href="#" class="btn btn-danger waves-effect" id="remove" data-id="<?php echo $pc->did; ?>" data-control="discount">Remove</a>
                            <?php } ?>
                          </div>
                        </td>
                      </tr>
        ...
        <?php if (checkPermission('create')) { ?>
          <a class="btn btn-danger btn--action btn--fixed zmdi zmdi-plus waves-effect" href="<?= site_url('sysadmin/discount/create'); ?>"></a>
        <?php } ?>
