...
<!--View Enquiry modal-->
<div class="modal fade note-view" id="view-productenquiries" data-backdrop="static" data-keyboard="false" style="display: none;" aria-hidden="true">
        ...
        <div class="card profile">
          <div class="profile__info">
            ...
            <dl class="row">
              ...
              <dd class="col-sm-3" id="proname"></dd>

              <dt class="col-sm-3">Quantity: </dt>
              <dd class="col-sm-3" id="qty"></dd>
...
<div class="toolbar">
  ...
  <div class="toolbar__search" style="display: none;">
    <input placeholder="Search..." type="text" name="list_searchkey" id="list_searchkey" data-control="productenquiries" data-forms_id="add_new_productenquiries">
  ...
  <div class="card-block">
    <table class="table mb-0">
      ...
      <tbody id="list_search_result">
        <?php
        $i = 1;
        if (!empty($productenquiries)) {
          foreach ($productenquiries as $pc) {
            ?>
            <tr>
              ...
              <td>
                <div class="btn-groups">
                  <button class="btn btn-primary waves-effect" data-toggle="modal" data-target="#view-productenquiries" type="button" data-id="<?= $pc->eid; ?>" title="View Enquiry" id="viewproductenquiry">View Enquiry</button>
                  <!-- <a href="#" class="btn btn-danger waves-effect" id="remove" data-id="<?php //echo $pc->eid;
                                                                                                ?>" data-control="productenquiries">Remove</a> </div></td> -->
            </tr>
          <?php $i++;
            }
          } else { ?>
...
<button class="btn btn-danger btn--action btn--fixed zmdi zmdi-plus waves-effect" data-toggle="modal" data-target="#add-productenquiries"></button>