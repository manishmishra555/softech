        ...
        <div>
          ...
          <div class="card">
            ...
            <div class="card-block"> <?php echo form_open('', ''); ?>
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group form-group--float"><?php echo form_input('faq_title', set_value('faq_title', $faq->faq_title, false), 'class="form-control" id="faq_title"'); ?> <?php echo form_label('Title', 'faq_title'); ?><i class="form-group__bar"></i> </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <label class="custom-control custom-radio">
                    <input name="status" class="custom-control-input" type="radio" value="active" <?php if ($faq->status == 'active') {
                                                                                                    echo "checked";
                                                                                                  } ?>>
                    <span class="custom-control-indicator"></span> <span class="custom-control-description">Active</span> </label>
                  <label class="custom-control custom-radio">
                    <input name="status" class="custom-control-input" type="radio" value="inactive" <?php if ($faq->status == 'inactive') {
                                                                                                      echo "checked";
                                                                                                    } ?>>
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <textarea class="form-control" rows="3" name="faq_desc" id="faq_desc" placeholder="Write here...."><?= $faq->faq_desc; ?></textarea>
              ...
              <div class="row">
                <div class="form-group--centered col-sm-12">
                  <?php echo form_hidden('faq_id', set_value('faq_id', $faq->faq_id)); ?> <?php echo form_label('&nbsp;', ''); ?> <?php echo form_button(array('type' => 'submit', 'name' => 'submit'), 'Save Changes', 'class="btn btn-success waves-effect"'); ?>
                  <?php echo form_button(array('type' => 'button'), 'Cancel', 'class="btn btn-danger waves-effect" onclick="window.location.href=\'' . site_url('sysadmin/faq') . '\'"'); ?> </div>
              </div>
              <?php echo form_close(); ?>
            </div>
          </div>
