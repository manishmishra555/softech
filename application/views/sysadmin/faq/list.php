...
<body data-ma-theme="red">
  <main class="main">
    ...
    <section class="content">
      <div class="">
        ...
        <!--Add new modal-->
        <div class="modal fade note-view" id="add-faq" data-backdrop="static" data-keyboard="false" style="display: none;" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Add New Faq</h5>
              </div>
              <?php echo form_open('sysadmin/faq/create', 'id="add_new_faq" name="add_new_faq" data-controller="faq"'); ?>
              <div class="modal-body">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group form-group--float"> <?php echo form_input('faq_title', set_value('faq_title'), 'class="form-control" id="faq_title"'); ?> <?php echo form_label('Title', 'faq_title'); ?><i class="form-group__bar"></i> </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <textarea class="form-control" rows="3" name="faq_desc" id="faq_desc" placeholder="Write here...."></textarea>
              ...
              <div class="modal-footer modal-footer--bordered">
                ...
                <?php echo form_button(array('type' => 'submit', 'name' => 'submit'), 'Create faq', 'class="btn btn-success waves-effect"'); ?> </div>
              <?php echo form_close(); ?>
            </div>s
          </div>
        </div>
      ...
      <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item">Last Modified</a> <a href="#" class="dropdown-item">Name</a> <a href="#" class="dropdown-item">Size</a> </div>
          ...
          <div class="toolbar__search" style="display: none;">
            <input placeholder="Search..." type="text" name="list_searchkey" id="list_searchkey" data-control="faq" data-forms_id="add_new_faq">
                  ...
                  if (!empty($faq)) {
                    foreach ($faq as $pc) {
                      ...
                      <tr>
                        ...
                        <td><?php echo $pc->faq_title; ?></td>
                        <td><?php if (checkPermission('edit')) { ?>
                            <div class="form-group">
                              <div class="toggle-switch">
                                ...
                                <input class="toggle-switch__checkbox" type="checkbox" <?php echo $status; ?> value="<?php echo $pc->status; ?>" data-id="<?php echo $pc->faq_id; ?>" data-control="faq" id="status<?php echo $pc->faq_id; ?>" title="<?php echo $title; ?>">
                        ...
                        <td>
                          <div class="btn-groups">
                            <?php if (checkPermission('edit')) { ?>
                              <?php echo anchor('sysadmin/faq/edit/' . $pc->faq_id, 'Edit', 'class="btn btn-primary waves-effect"'); ?>
                            <?php }
                            if (checkPermission('delete')) { ?>
                              <a href="#" class="btn btn-danger waves-effect" id="remove" data-id="<?php echo $pc->faq_id; ?>" data-control="faq">Remove</a>
                            <?php } ?>
                          </div>
                        </td>
                      </tr>
        ...
        <?php if (checkPermission('create')) { ?>
          <button class="btn btn-danger btn--action btn--fixed zmdi zmdi-plus waves-effect" data-toggle="modal" data-target="#add-faq"></button>
        <?php } ?>
  ...
  <script type="text/javascript">
    var editor = CKEDITOR.replace('faq_desc', {
